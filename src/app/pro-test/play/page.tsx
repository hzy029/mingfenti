...
import { BASIC_TEST_SESSION_STORAGE_KEY, type BasicTestSessionPro } from "@/lib/basic-test-session";
...
export default function ProTestPlayPage() {
  ...
  function completeTest(finalAnswers: BasicAnswerMap) {
    ...
    const session: BasicTestSessionPro = {
      testVariant: "pro",
      questions,
      ...
      <main className="mx-auto flex min-h-[calc(100vh-74px)] w-full max-w-4xl flex-col px-5 py-6">
        <section className="py-6">
          <div className="mb-4 flex flex-wrap items-center justify-between gap-3 text-sm text-[#5d5447]">
            <span className="font-black text-[#4937db]">Pro 版检测 · 四选一</span>
            <span>
        ...
        <section className="rounded-lg border border-[#15120d]/10 bg-white p-5 shadow-sm">
          <div className="mb-4 flex flex-wrap gap-2">
            <span className="rounded-md bg-[#4937db]/15 px-2 py-1 text-xs font-bold text-[#4338ca]">
